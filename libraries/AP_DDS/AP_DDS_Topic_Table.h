...
constexpr struct AP_DDS_Client::Topic_table AP_DDS_Client::topics[] = {
#if AP_DDS_TIME_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::TIME_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::TIME_PUB),
...
#if AP_DDS_NAVSATFIX_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::NAV_SAT_FIX_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::NAV_SAT_FIX_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_STATIC_TF_PUB_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::STATIC_TRANSFORMS_PUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::STATIC_TRANSFORMS_PUB),
                        .type = UXR_DATAREADER_ID},
...
#if AP_DDS_BATTERY_STATE_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::BATTERY_STATE_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::BATTERY_STATE_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_IMU_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::IMU_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::IMU_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_LOCAL_POSE_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_POSE_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_POSE_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_LOCAL_VEL_PUB_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_VELOCITY_PUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_VELOCITY_PUB),
                        .type = UXR_DATAREADER_ID},
...
#if AP_DDS_AIRSPEED_PUB_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_AIRSPEED_PUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_AIRSPEED_PUB),
                        .type = UXR_DATAREADER_ID},
...
#if AP_DDS_GEOPOSE_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::GEOPOSE_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::GEOPOSE_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_CLOCK_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::CLOCK_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::CLOCK_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_CLOCK_SUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::CLOCK_SUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::CLOCK_SUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataReader,
        .topic_name = "rt/ap/clock_sub",
        .type_name = "rosgraph_msgs::msg::dds_::Clock_",
        .qos =
            {
                .durability = UXR_DURABILITY_VOLATILE,
...
#if AP_DDS_GPS_GLOBAL_ORIGIN_PUB_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::GPS_GLOBAL_ORIGIN_PUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::GPS_GLOBAL_ORIGIN_PUB),
                        .type = UXR_DATAREADER_ID},
...
#if AP_DDS_JOY_SUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::JOY_SUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::JOY_SUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataReader,
...
#if AP_DDS_DYNAMIC_TF_SUB_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::DYNAMIC_TRANSFORMS_SUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::DYNAMIC_TRANSFORMS_SUB),
                        .type = UXR_DATAREADER_ID},
...
#if AP_DDS_VEL_CTRL_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::VELOCITY_CONTROL_SUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::VELOCITY_CONTROL_SUB),
                        .type = UXR_DATAREADER_ID},
...
#if AP_DDS_GLOBAL_POS_CTRL_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::GLOBAL_POSITION_SUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::GLOBAL_POSITION_SUB),
                        .type = UXR_DATAREADER_ID},
...
#if AP_DDS_RANGEFINDER_SUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::RANGEFINDER_SUB),
                             .type = UXR_DATAWRITER_ID},
...
#if AP_DDS_STATE_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::STATE_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::STATE_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_EKF_STATUS_PUB_ENABLED
    {
        ...
        .dw_id = uxrObjectId{.id = to_underlying(TopicIndex::EKF_STATUS_PUB),
                             .type = UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id = to_underlying(TopicIndex::EKF_STATUS_PUB),
                             .type = UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_OBSTACLE_DISTANCE_SUB_ENABLED
    {
        ...
        .dw_id =
            uxrObjectId{.id = to_underlying(TopicIndex::OBSTACLE_DISTANCE_SUB),
                        .type = UXR_DATAWRITER_ID},
        .dr_id =
            uxrObjectId{.id = to_underlying(TopicIndex::OBSTACLE_DISTANCE_SUB),
                        .type = UXR_DATAREADER_ID},
