...
#if AP_DDS_COMMAND_LONG_SERVER_ENABLED
    {
        .req_id = to_underlying(ServiceIndex::COMMAND_LONG),
        .rep_id = to_underlying(ServiceIndex::COMMAND_LONG),
        .service_rr = Service_rr::Replier,
        .service_name = "rs/ap/send_commandService",
        .request_type = "ardupilot_msgs::srv::dds_::CommandLong_Request_",
        .reply_type = "ardupilot_msgs::srv::dds_::CommandLong_Response_",
        .request_topic_name = "rq/ap/send_commandRequest",
        .reply_topic_name = "rr/ap/send_commandReply",
        .qos =
            {
